    ...
    return(
        <tbody>
            <tr className="max-sm:hidden">
                ...
                <td className={props.tipo === "saida" ? "text-[var(--cor-negativa-vermelho)] bg-[var(--cor-destaque)] w-1/3 first:rounded-l-md last:rounded-r-md py-5 px-8" : "text-[var(--cor-positiva-verde)] bg-[var(--cor-destaque)] w-1/3 first:rounded-l-md last:rounded-r-md py-5 px-8"}>R$ {props.preco}</td>
            ...
            <tr className="sm:hidden">
                <td className="bg-[var(--cor-destaque)] first:rounded-l-md last:rounded-r-md py-5 px-8">
                    <div className="flex flex-col gap-2">
                        ...
                        <span className={props.tipo === "saida" ? "text-[var(--cor-negativa-vermelho)] font-bold text-xl" : "text-[var(--cor-positiva-verde)] font-bold text-xl"}>R$ {props.preco}</span>
                    </div>
