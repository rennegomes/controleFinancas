...
export default function Resumo() {
  return (
   <div className="flex justify-between overflow-x-auto whitespace-nowrap md:grid grid-cols-3 gap-8 mt-[-5rem] w-full max-w-6xl mx-auto px-6 pb-2">
    ...
    <div className="flex flex-col min-w-72 bg-[var(--cor-destaque)] p-5 rounded-md">
    ...
    <div className="flex flex-col min-w-72 bg-[var(--cor-positiva-verde-escuro)] p-5 rounded-md">
        <div className="flex justify-between items-center pb-5">
            <span>Total</span>
